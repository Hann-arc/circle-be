...
const threadsRouter = (0, express_1.Router)();
threadsRouter.get("/me", threadController.threadMe);
threadsRouter.post("/", file_upload_1.default.single('media'), threadController.createThread);
